...
<head>
  ...
  <meta name="description" content="Best bands and groups on Americn Rockband voice-only Alexa Game.">
  <meta name="keywords" content="top bands, alexa games, best groups, american rockstar">
  <title>AmericanBand.io | Top Bands with Most fans and thier values</title>
      ...
      <div id="content-area" class="site-content-area">
        <div id="content-area-inner" class="site-content-area-inner">
          ...
          <section class="section  is-clearfix">
              <div class="container">
                <h1 class="heading-title style-1">Most Popular Bands</h1>
            ...
            <section class="section hero has-background-primary-light is-clearfix">
              <div class="container">
                <!-- <h1 class="heading-title style-1">From the Fans</h1> -->
                <br>
                <div class="columns is-variable is-multiline is-centered">
                  <div class="content column is-8">
           
                    <blockquote class="style-3 is-danger"> If being an egomaniac means I believe in what I do and, in my art, or music, then in that respect you can call me that...  I believe in what I do, and I'll say it. "
